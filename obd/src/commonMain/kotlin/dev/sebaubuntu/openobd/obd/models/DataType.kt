...
import dev.sebaubuntu.openobd.core.models.value.Time
...
sealed class DataType<T>(
    ...
    data object CALCULATED_ENGINE_LOAD : DataType<Percentage>(
        ...
        expectedBytes = 1,
        responseParser = {
            it[0].toInt().div(255f).asValue(Percentage.Unit.PERCENT)
        },
    )
    ...
    data object ENGINE_COOLANT_TEMPERATURE : DataType<Temperature>(
        ...
        expectedBytes = 1,
        responseParser = {
            it[0].toInt().minus(40).toFloat().asValue(Temperature.Unit.CELSIUS)
        },
    )
    ...
    data object FUEL_PRESSURE : DataType<Pressure>(
        ...
        expectedBytes = 1,
        responseParser = {
            it[0].toFloat().times(3).asValue(Pressure.Unit.KILOPASCAL)
        },
    )
    ...
    data object INTAKE_MANIFOLD_ABSOLUTE_PRESSURE : DataType<Pressure>(
        ...
        expectedBytes = 1,
        responseParser = {
            it[0].toFloat().asValue(Pressure.Unit.KILOPASCAL)
        },
    )
    ...
    data object ENGINE_SPEED : DataType<Frequency>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toFloat().div(4f).asValue(Frequency.Unit.REVOLUTION_PER_MINUTE)
        },
    )
    ...
    data object VEHICLE_SPEED : DataType<Speed>(
        ...
        expectedBytes = 1,
        responseParser = {
            it[0].toFloat().asValue(Speed.Unit.KILOMETER_PER_HOUR)
        },
    )
     ...
     */
    data object OXYGEN_SENSORS_PRESENT_2_BANKS : DataType<Nothing>(0x13u)
     ...
     */
    data object OXYGEN_SENSOR_1_V_STFT : DataType<Nothing>(0x14u)
     ...
     * - B: Short term fuel trim
     */
    data object OXYGEN_SENSOR_2_V_STFT : DataType<Nothing>(0x15u)
     ...
     * - B: Short term fuel trim
     */
    data object OXYGEN_SENSOR_3_V_STFT : DataType<Nothing>(0x16u)
     ...
     * - B: Short term fuel trim
     */
    data object OXYGEN_SENSOR_4_V_STFT : DataType<Nothing>(0x17u)
     ...
     * - B: Short term fuel trim
     */
    data object OXYGEN_SENSOR_5_V_STFT : DataType<Nothing>(0x18u)
     ...
     * - B: Short term fuel trim
     */
    data object OXYGEN_SENSOR_6_V_STFT : DataType<Nothing>(0x19u)
     ...
     * - B: Short term fuel trim
     */
    data object OXYGEN_SENSOR_7_V_STFT : DataType<Nothing>(0x1Au)
     ...
     * - B: Short term fuel trim
     */
    data object OXYGEN_SENSOR_8_V_STFT : DataType<Nothing>(0x1Bu)
     ...
     */
    data object OXYGEN_SENSORS_PRESENT_4_BANKS : DataType<Nothing>(0x1Du)
     ...
     */
    data object RUN_TIME_SINCE_ENGINE_START : DataType<Time>(
        parameterId = 0x1Fu,
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toLong().asValue(Time.Unit.SECOND)
        },
    )
     ...
     */
    data object DISTANCE_TRAVELED_WITH_MIL_ON : DataType<Time>(
        parameterId = 0x21u,
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toLong().asValue(Time.Unit.SECOND)
    ...
    data object FUEL_RAIL_PRESSURE : DataType<Pressure>(
        ...
        expectedBytes = 2,
        responseParser = {
            0.079f.times(it.toUShort().toInt()).asValue(Pressure.Unit.KILOPASCAL)
        },
    )
    ...
    data object FUEL_RAIL_GAUGE_PRESSURE : DataType<Pressure>(
        ...
        expectedBytes = 2,
        responseParser = {
            10f.times(it.toUShort().toInt()).asValue(Pressure.Unit.KILOPASCAL)
        },
    )
     ...
     * - CD: Voltage
     */
    data object OXYGEN_SENSOR_1_AF_V : DataType<Nothing>(0x24u)
     ...
     * - CD: Voltage
     */
    data object OXYGEN_SENSOR_2_AF_V : DataType<Nothing>(0x25u)
     ...
     * - CD: Voltage
     */
    data object OXYGEN_SENSOR_3_AF_V : DataType<Nothing>(0x26u)
     ...
     * - CD: Voltage
     */
    data object OXYGEN_SENSOR_4_AF_V : DataType<Nothing>(0x27u)
     ...
     * - CD: Voltage
     */
    data object OXYGEN_SENSOR_5_AF_V : DataType<Nothing>(0x28u)
     ...
     * - CD: Voltage
     */
    data object OXYGEN_SENSOR_6_AF_V : DataType<Nothing>(0x29u)
     ...
     * - CD: Voltage
     */
    data object OXYGEN_SENSOR_7_AF_V : DataType<Nothing>(0x2Au)
     ...
     * - CD: Voltage
     */
    data object OXYGEN_SENSOR_8_AF_V : DataType<Nothing>(0x2Bu)
    ...
    data object EGR_ERROR : DataType<Percentage>(
        ...
        responseParser = {
            it[0].toInt().div(255f)
                .minus(1)
                .asValue(Percentage.Unit.PERCENT)
        },
    )
    ...
    data object DISTANCE_TRAVELED_SINCE_CODES_CLEARED : DataType<Length>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toFloat().asValue(Length.Unit.KILOMETER)
        },
    )
    ...
    data object EVAPORATION_SYSTEM_VAPOR_PRESSURE : DataType<Pressure>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toShort().div(4f).asValue(Pressure.Unit.PASCAL)
        },
    )
     ...
     * - CD: Current
     */
    data object OXYGEN_SENSOR_1_AF_A : DataType<Nothing>(0x34u)
     ...
     * - CD: Current
     */
    data object OXYGEN_SENSOR_2_AF_A : DataType<Nothing>(0x35u)
     ...
     * - CD: Current
     */
    data object OXYGEN_SENSOR_3_AF_A : DataType<Nothing>(0x36u)
     ...
     * - CD: Current
     */
    data object OXYGEN_SENSOR_4_AF_A : DataType<Nothing>(0x37u)
     ...
     * - CD: Current
     */
    data object OXYGEN_SENSOR_5_AF_A : DataType<Nothing>(0x38u)
     ...
     * - CD: Current
     */
    data object OXYGEN_SENSOR_6_AF_A : DataType<Nothing>(0x39u)
     ...
     * - CD: Current
     */
    data object OXYGEN_SENSOR_7_AF_A : DataType<Nothing>(0x3Au)
     ...
     * - CD: Current
     */
    data object OXYGEN_SENSOR_8_AF_A : DataType<Nothing>(0x3Bu)
    ...
    data object CONTROL_MODULE_VOLTAGE : DataType<Voltage>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toInt().div(1000f).asValue(Voltage.Unit.VOLT)
        },
    )
    ...
    data object ABSOLUTE_LOAD_VALUE : DataType<Percentage>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toInt().div(255f).asValue(Percentage.Unit.PERCENT)
        },
    )
     ...
     */
    data object TIME_RUN_WITH_MIL_ON : DataType<Time>(
        parameterId = 0x4Du,
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toLong().asValue(Time.Unit.MINUTE)
        },
    )
     ...
     */
    data object TIME_SINCE_TROUBLE_CODES_CLEARED : DataType<Time>(
        parameterId = 0x4Eu,
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toLong().asValue(Time.Unit.MINUTE)
     ...
     */
    data object MAXIMUM_VALUE_FOR_FAER_O2V_O2A_INTAKE_PRESSURE : DataType<Nothing>(0x4Fu)

    /**
     * Maximum value for air flow rate from mass air flow sensor.
     */
    data object MAXIMUM_VALUE_FOR_MAF_AIR_FLOW_RATE : DataType<MassFlowRate>(
        parameterId = 0x50u,
        expectedBytes = 4,
        responseParser = {
            it[0].toInt().times(10).toFloat().asValue(MassFlowRate.Unit.GRAM_PER_SECOND)
        },
    )
    ...
    data object ABSOLUTE_EVAP_SYSTEM_VAPOR_PRESSURE : DataType<Pressure>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toInt().div(200f).asValue(Pressure.Unit.KILOPASCAL)
        },
    )
    ...
    data object EVAP_SYSTEM_VAPOR_PRESSURE : DataType<Pressure>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toShort().toFloat().asValue(Pressure.Unit.PASCAL)
        },
    )
     ...
     */
    data object SHORT_TERM_SECONDARY_OXYGEN_SENSOR_TRIM_1_3 : DataType<Nothing>(0x55u)

    /**
     * Long term secondary oxygen sensor trim, A: bank 1, B: bank 3.
     */
    data object LONG_TERM_SECONDARY_OXYGEN_SENSOR_TRIM_1_3 : DataType<Nothing>(0x56u)

    /**
     * Short term secondary oxygen sensor trim, A: bank 2, B: bank 4.
     */
    data object SHORT_TERM_SECONDARY_OXYGEN_SENSOR_TRIM_2_4 : DataType<Nothing>(0x57u)

    /**
     * Long term secondary oxygen sensor trim, A: bank 2, B: bank 4.
     */
    data object LONG_TERM_SECONDARY_OXYGEN_SENSOR_TRIM_2_4 : DataType<Nothing>(0x58u)
    ...
    data object FUEL_RAIL_ABSOLUTE_PRESSURE : DataType<Pressure>(
        ...
        responseParser = {
            it.toUShort().toInt()
                .times(10)
                .toFloat().asValue(Pressure.Unit.KILOPASCAL)
        }
    )
    ...
    data object ENGINE_FUEL_RATE : DataType<VolumeFlowRate>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toInt().div(20f).asValue(VolumeFlowRate.Unit.LITER_PER_HOUR)
        },
    )
     ...
     */
    data object DRIVER_DEMAND_ENGINE_PERCENT_TORQUE : DataType<Nothing>(0x61u)

    /**
     * Actual engine - percent torque.
     */
    data object ACTUAL_ENGINE_PERCENT_TORQUE : DataType<Nothing>(0x62u)

    /**
     * Engine reference torque.
     */
    data object ENGINE_REFERENCE_TORQUE : DataType<Nothing>(0x63u)

    /**
     * Engine percent torque data.
     */
    data object ENGINE_PERCENT_TORQUE_DATA : DataType<Nothing>(0x64u)

    /**
     * Auxiliary input / output supported.
     */
    data object AUXILIARY_INPUT_OUTPUT_SUPPORTED : DataType<Nothing>(0x65u)

    /**
     * Mass air flow sensor.
     */
    data object MASS_AIR_FLOW_SENSOR : DataType<Nothing>(0x66u)

    /**
     * Engine coolant temperature.
     */
    data object ENGINE_COOLANT_TEMPERATURE_2_SENSORS : DataType<Nothing>(0x67u)

    /**
     * Intake air temperature sensor.
     */
    data object INTAKE_AIR_TEMPERATURE_SENSOR : DataType<Nothing>(0x68u)

    /**
     * Actual EGR, Commanded EGR, and EGR Error.
     */
    data object EGR_ACTUAL_COMMANDED_ERROR : DataType<Nothing>(0x69u)
    ...
    data object COMMANDED_DIESEL_INTAKE_AIR_FLOW_CONTROL_AND_RELATIVE_INTAKE_AIR_FLOW_POSITION :
        DataType<Nothing>(0x6Au)

    /**
     * Exhaust gas recirculation temperature.
     */
    data object EXHAUST_GAS_RECIRCULATION_TEMPERATURE : DataType<Nothing>(0x6Bu)
    ...
    data object COMMANDED_THROTTLE_ACTUATOR_CONTROL_AND_RELATIVE_THROTTLE_POSITION :
        DataType<Nothing>(0x6Cu)

    /**
     * Fuel pressure control system.
     */
    data object FUEL_PRESSURE_CONTROL_SYSTEM : DataType<Nothing>(0x6Du)

    /**
     * Injection pressure control system.
     */
    data object INJECTION_PRESSURE_CONTROL_SYSTEM : DataType<Nothing>(0x6Eu)

    /**
     * Turbocharger compressor inlet pressure.
     */
    data object TURBOCHARGER_COMPRESSOR_INLET_PRESSURE : DataType<Nothing>(0x6Fu)

    /**
     * Boost pressure control.
     */
    data object BOOST_PRESSURE_CONTROL : DataType<Nothing>(0x70u)

    /**
     * Variable Geometry turbo (VGT) control.
     */
    data object VARIABLE_GEOMETRY_TURBO_CONTROL : DataType<Nothing>(0x71u)

    /**
     * Wastegate control.
     */
    data object WASTEGATE_CONTROL : DataType<Nothing>(0x72u)

    /**
     * Exhaust pressure.
     */
    data object EXHAUST_PRESSURE : DataType<Nothing>(0x73u)

    /**
     * Turbocharger RPM.
     */
    data object TURBOCHARGER_RPM : DataType<Nothing>(0x74u)

    /**
     * Turbocharger temperature.
     */
    data object TURBOCHARGER_TEMPERATURE : DataType<Nothing>(0x75u)

    /**
     * Turbocharger temperature.
     */
    data object TURBOCHARGER_TEMPERATURE_2 : DataType<Nothing>(0x76u) // TODO: ??

    /**
     * Charge air cooler temperature (CACT).
     */
    data object CHARGE_AIR_COOLER_TEMPERATURE : DataType<Nothing>(0x77u)

    /**
     * Exhaust Gas temperature (EGT) Bank 1.
     */
    data object EXHAUST_GAS_TEMPERATURE_BANK_1 : DataType<Nothing>(0x78u)

    /**
     * Exhaust Gas temperature (EGT) Bank 2.
     */
    data object EXHAUST_GAS_TEMPERATURE_BANK_2 : DataType<Nothing>(0x79u)

    /**
     * Diesel particulate filter (DPF) differential pressure.
     */
    data object DIESEL_PARTICULATE_FILTER_DIFFERENTIAL_PRESSURE : DataType<Nothing>(0x7Au)

    /**
     * Diesel particulate filter (DPF).
     */
    data object DIESEL_PARTICULATE_FILTER : DataType<Nothing>(0x7Bu) // TODO: What?

    /**
     * Diesel Particulate filter (DPF) temperature.
     */
    data object DIESEL_PARTICULATE_FILTER_TEMPERATURE : DataType<Temperature>(
        parameterId = 0x7Cu,
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toFloat()
                .div(10f)
                .minus(40)
                .asValue(Temperature.Unit.CELSIUS)
        },
    )
     ...
     */
    data object NOX_NTE_CONTROL_AREA_STATUS : DataType<Nothing>(0x7Du)

    /**
     * PM NTE (Not-To-Exceed) control area status.
     */
    data object PM_NTE_CONTROL_AREA_STATUS : DataType<Nothing>(0x7Eu)

    /**
     * Engine run time.
     */
    data object ENGINE_RUN_TIME : DataType<Nothing>(0x7Fu)
     ...
     */
    data object ENGINE_RUN_TIME_FOR_AECD_1_5 : DataType<Nothing>(0x81u)

    /**
     * Engine run time for Auxiliary Emissions Control Device (AECD) #6-#10.
     */
    data object ENGINE_RUN_TIME_FOR_AECD_6_10 : DataType<Nothing>(0x82u) // TODO: What?

    /**
     * NOx sensor.
     */
    data object NOX_SENSOR : DataType<Nothing>(0x83u)

    /**
     * Manifold surface temperature.
     */
    data object MANIFOLD_SURFACE_TEMPERATURE : DataType<Nothing>(0x84u)

    /**
     * NOx reagent system.
     */
    data object NOX_REAGENT_SYSTEM : DataType<Nothing>(0x85u)

    /**
     * Particulate matter (PM) sensor.
     */
    data object PARTICULATE_MATTER_SENSOR : DataType<Nothing>(0x86u)

    /**
     * Intake manifold absolute pressure.
     */
    data object INTAKE_MANIFOLD_ABSOLUTE_PRESSURE_2 : DataType<Nothing>(0x87u) // TODO: Duplicate

    /**
     * SCR Induce System.
     */
    data object SCR_INDUCE_SYSTEM : DataType<Nothing>(0x88u)

    /**
     * Engine run time for Auxiliary Emissions Control Device (AECD) #11-#15.
     */
    data object RUN_TIME_FOR_AECD_11_15 : DataType<Nothing>(0x89u)

    /**
     * Engine run time for Auxiliary Emissions Control Device (AECD) #16-#20.
     */
    data object RUN_TIME_FOR_AECD_16_20 : DataType<Nothing>(0x8Au)

    /**
     * Diesel Aftertreatment.
     */
    data object DIESEL_AFTERTREATMENT : DataType<Nothing>(0x8Bu)

    /**
     * O2 Sensor (Wide Range).
     */
    data object O2_SENSOR_WIDE_RANGE : DataType<Nothing>(0x8Cu)

    /**
     * Throttle Position G.
     */
    data object THROTTLE_POSITION_G : DataType<Nothing>(0x8Du)

    /**
     * Engine Friction - Percent Torque.
     */
    data object ENGINE_FRICTION_PERCENT_TORQUE : DataType<Nothing>(0x8Eu)

    /**
     * PM Sensor Bank 1 & 2.
     */
    data object PM_SENSOR_BANK_1_2 : DataType<Nothing>(0x8Fu)

    /**
     * WWH-OBD Vehicle OBD System Information.
     */
    data object WWH_OBD_VEHICLE_OBD_SYSTEM_INFORMATION : DataType<Nothing>(0x90u)

    /**
     * WWH-OBD Vehicle OBD System Information.
     */
    data object WWH_OBD_VEHICLE_OBD_SYSTEM_INFORMATION_2 : DataType<Nothing>(0x91u) // TODO: What?

    /**
     * Fuel System Control.
     */
    data object FUEL_SYSTEM_CONTROL : DataType<Nothing>(0x92u)

    /**
     * WWH-OBD Vehicle OBD Counters support.
     */
    data object WWH_OBD_VEHICLE_OBD_COUNTERS_SUPPORT : DataType<Nothing>(0x93u)

    /**
     * NOx Warning And Inducement System.
     */
    data object NOX_WARNING_AND_INDUCEMENT_SYSTEM : DataType<Nothing>(0x94u)

    /**
     * Exhaust Gas Temperature Sensor.
     */
    data object EXHAUST_GAS_TEMPERATURE_SENSOR : DataType<Nothing>(0x98u)

    /**
     * Exhaust Gas Temperature Sensor.
     */
    data object EXHAUST_GAS_TEMPERATURE_SENSOR_2 : DataType<Nothing>(0x99u) // TODO: What?

    /**
     * Hybrid/EV Vehicle System Data, Battery, Voltage.
     */
    data object HYBRID_EV_VEHICLE_SYSTEM_DATA_BATTERY_VOLTAGE : DataType<Nothing>(0x9Au)

    /**
     * Diesel Exhaust Fluid Sensor Data.
     */
    data object DIESEL_EXHAUST_FLUID_SENSOR_DATA : DataType<Nothing>(0x9Bu)

    /**
     * O2 Sensor Data.
     */
    data object O2_SENSOR_DATA : DataType<Nothing>(0x9Cu)

    /**
     * Engine Fuel Rate.
     */
    data object ENGINE_FUEL_RATE_2 : DataType<Nothing>(0x9Du) // TODO: Duplicate

    /**
     * Engine Exhaust Flow Rate.
     */
    data object ENGINE_EXHAUST_FLOW_RATE : DataType<Nothing>(0x9Eu)

    /**
     * Fuel System Percentage Use.
     */
    data object FUEL_SYSTEM_PERCENTAGE_USE : DataType<Nothing>(0x9Fu)
     ...
     */
    data object NOX_SENSOR_CORRECTED_DATA : DataType<Nothing>(0xA1u)

    /**
     * Cylinder Fuel Rate.
     */
    data object CYLINDER_FUEL_RATE : DataType<Nothing>(0xA2u)

    /**
     * Evap System Vapor Pressure.
     */
    data object EVAP_SYSTEM_VAPOR_PRESSURE_2 : DataType<Nothing>(0xA3u) // TODO: Duplicate

    /**
     * Transmission Actual Gear.
     */
    data object TRANSMISSION_ACTUAL_GEAR : DataType<Nothing>(0xA4u)

    /**
     * Commanded Diesel Exhaust Fluid Dosing.
     */
    data object COMMANDED_DIESEL_EXHAUST_FLUID_DOSING : DataType<Nothing>(0xA5u)
     ...
     */
    data object NOX_SENSOR_CONCENTRATION_SENSORS_3_4 : DataType<Nothing>(0xA7u)

    /**
     * NOx Sensor Corrected Concentration Sensors 3 and 4.
     */
    data object NOX_SENSOR_CORRECTED_CONCENTRATION_SENSORS_3_4 : DataType<Nothing>(0xA8u)

    /**
     * ABS Disable Switch State.
     */
    data object ABS_DISABLE_SWITCH_STATE : DataType<Nothing>(0xA9u)
     ...
     */
    data object FUEL_LEVEL_INPUT_A_B : DataType<Nothing>(0xC3u)

    /**
     * Exhaust Particulate Control System Diagnostic Time/Count.
     */
    data object EXHAUST_PARTICULATE_CONTROL_SYSTEM_DIAGNOSTIC_TIME_COUNT : DataType<Nothing>(0xC4u)

    /**
     * Fuel Pressure A and B.
     */
    data object FUEL_PRESSURE_A_B : DataType<Nothing>(0xC5u)
     ...
     */
    data object DISTANCE_SINCE_REFLASH_OR_MODULE_REPLACEMENT : DataType<Nothing>(0xC7u)

    /**
     * NOx Control Diagnostic (NCD) and Particulate Control Diagnostic (PCD) Warning Lamp status.
     */
    data object NCD_AND_PCD_WARNING_LAMP_STATUS : DataType<Nothing>(0xC8u)
    ...
    companion object {
        val all by lazy {
            listOf<DataType<*>>(
                ...
                MAXIMUM_VALUE_FOR_FAER_O2V_O2A_INTAKE_PRESSURE,
                MAXIMUM_VALUE_FOR_MAF_AIR_FLOW_RATE,
                FUEL_TYPE,
                ...
                DIESEL_PARTICULATE_FILTER_DIFFERENTIAL_PRESSURE,
        ...
        private val positionParser = { response: UByteArray ->
            response[0].toInt().div(255f).asValue(Percentage.Unit.PERCENT)
        }
    }
}
