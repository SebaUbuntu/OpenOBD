...
import dev.sebaubuntu.openobd.storage.preferences.Preference.Companion.booleanPreference
import dev.sebaubuntu.openobd.storage.preferences.Preference.Companion.enumPreference
import dev.sebaubuntu.openobd.storage.preferences.Preference.Companion.stringPreference
...
class PreferencesRepository(
    ...
    val dynamicColors = booleanPreference(
        "dynamic_colors",
        true,
    ).asPreferenceHolder()
    ...
    val profileId = stringPreference(
        "profile_id",
        Profile.DEFAULT.id,
    ).asPreferenceHolder()
