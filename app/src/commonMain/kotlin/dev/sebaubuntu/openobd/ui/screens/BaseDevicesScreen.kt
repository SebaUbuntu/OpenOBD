...
import dev.sebaubuntu.openobd.ext.drawableResource
import dev.sebaubuntu.openobd.ext.stringResource
...
import dev.sebaubuntu.openobd.viewmodels.BaseDevicesViewModel
...
inline fun <reified VM : BaseDevicesViewModel<D, ID>,
    ...
    val content = @Composable {
        ...
        DevicesListComposable(
            paddingValues = paddingValues,
            canBeToggled = baseDevicesViewModel.canBeToggled,
    ...
    ElevatedCard(
        ...
        Row(
            modifier = modifier
                .toggleable(
                    value = value,
                    enabled = canBeToggled && when (deviceManagerState) {
                        DeviceManager.State.UNAVAILABLE -> false
