...
package dev.sebaubuntu.openobd.obd2.utils

import dev.sebaubuntu.openobd.core.models.Result.Companion.getOrNull
import dev.sebaubuntu.openobd.elm327.utils.IsoTpDecoder
import dev.sebaubuntu.openobd.elm327.utils.ProtocolDecoder
import dev.sebaubuntu.openobd.logging.Logger
import dev.sebaubuntu.openobd.obd2.models.ControlModule
...
object ObdResponseParser {
    ...
    private fun parseLine(
        ...
        ObdResponse.MessageFormat.ISO_TP -> parseIsoTpLine(line)
    ...
    private fun guessProtocol(line: String) = when {
        line.matches(isoTpResponseRegex) -> ObdResponse.MessageFormat.ISO_TP
