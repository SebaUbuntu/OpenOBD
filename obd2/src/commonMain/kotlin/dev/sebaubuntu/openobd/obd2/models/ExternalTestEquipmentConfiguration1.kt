...
data class ExternalTestEquipmentConfiguration1(
    ...
    companion object {
        ...
        fun fromObdValue(obdValue: UByteArray): ExternalTestEquipmentConfiguration1 {
            ...
            val oxygenSensorMaxVoltage = obdValue[1].toFloat().asValue(Voltage.Unit.VOLT)
            val oxygenSensorMaxCurrent = obdValue[2].toFloat().asValue(Current.Unit.MILLIAMPERE)
            val intakeManifoldMaxAbsolutePressure = obdValue[3].toInt()
                .times(10)
