...
sealed class DataType<T>(
    ...
    data object CALCULATED_ENGINE_LOAD : DataType<Percentage>(
        ...
        expectedBytes = 1,
        responseParser = {
            it[0].toInt().div(2.55f).asValue(Percentage.Unit.PERCENT)
        },
    )
    ...
    data object ENGINE_COOLANT_TEMPERATURE : DataType<Temperature>(
        ...
        expectedBytes = 1,
        responseParser = {
            it[0].toInt().minus(40).asValue(Temperature.Unit.CELSIUS)
        },
    )
    ...
    data object FUEL_PRESSURE : DataType<Pressure>(
        ...
        expectedBytes = 1,
        responseParser = {
            it[0].toInt().times(3).asValue(Pressure.Unit.KILOPASCAL)
        },
    )
    ...
    data object INTAKE_MANIFOLD_ABSOLUTE_PRESSURE : DataType<Pressure>(
        ...
        expectedBytes = 1,
        responseParser = {
            it[0].toInt().asValue(Pressure.Unit.KILOPASCAL)
        },
    )
    ...
    data object ENGINE_SPEED : DataType<Frequency>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toInt().div(4f).asValue(Frequency.Unit.REVOLUTION_PER_MINUTE)
        },
    )
    ...
    data object VEHICLE_SPEED : DataType<Speed>(
        ...
        expectedBytes = 1,
        responseParser = {
            it[0].toInt().asValue(Speed.Unit.KILOMETER_PER_HOUR)
        },
    )
    ...
    data object RUN_TIME_SINCE_ENGINE_START : DataType<Time>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toInt().asValue(Time.Unit.SECOND)
        },
    )
    ...
    data object DISTANCE_TRAVELED_SINCE_CODES_CLEARED : DataType<Length>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toInt().asValue(Length.Unit.KILOMETER)
        },
    )
    ...
    data object EVAPORATION_SYSTEM_VAPOR_PRESSURE : DataType<Pressure>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toShort().div(4f).asValue(Pressure.Unit.PASCAL) // TODO check negative
        },
    )
    ...
    data object ABSOLUTE_BAROMETRIC_PRESSURE : DataType<Pressure>(
        ...
        expectedBytes = 1,
        responseParser = {
            it[0].toShort().asValue(Pressure.Unit.KILOPASCAL)
        },
    )
    ...
    data object CONTROL_MODULE_VOLTAGE : DataType<Voltage>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toInt().asValue(Voltage.Unit.MILLIVOLT)
        },
    )
    ...
    data object ABSOLUTE_LOAD_VALUE : DataType<Percentage>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toInt().div(2.55f).asValue(Percentage.Unit.PERCENT)
        },
    )
    ...
    data object TIME_RUN_WITH_MIL_ON : DataType<Time>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toInt().asValue(Time.Unit.MINUTE)
        },
    )
    ...
    data object EVAP_SYSTEM_VAPOR_PRESSURE : DataType<Pressure>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toShort().toFloat().asValue(Pressure.Unit.PASCAL) // TODO: Check negative
        },
    )
    ...
    data object ENGINE_REFERENCE_TORQUE : DataType<Torque>(
        ...
        expectedBytes = 2,
        responseParser = {
            it.toUShort().toInt().asValue(Torque.Unit.NEWTON_METER)
        },
    )
    ...
    companion object {
        ...
        private val oxygenSensorVStftParser = { response: UByteArray ->
            ...
            val stft = response[1].takeIf { it != 0xFFu.toUByte() }?.toInt()?.div(1.28f)
                ?.minus(1)
                ?.asValue(Percentage.Unit.PERCENT)
        ...
        private val positionParser = { response: UByteArray ->
            response[0].toInt().div(2.55f).asValue(Percentage.Unit.PERCENT)
        }
