...
inline fun Collection<UByte>.toUByte() = toUNumber(
    UByte.SIZE_BYTES,
    0u,
    ULong::toUByte,
    UByte::or,
 ...
 */
@ExperimentalUnsignedTypes
inline fun Collection<UByte>.toUShort() = toUNumber(
    UShort.SIZE_BYTES,
    0u,
    ULong::toUShort,
    UShort::or,
 ...
 */
@ExperimentalUnsignedTypes
inline fun Collection<UByte>.toUInt() = toUNumber(
    UInt.SIZE_BYTES,
    0u,
    ULong::toUInt,
    UInt::or,
 ...
 */
@ExperimentalUnsignedTypes
inline fun Collection<UByte>.toULong() = toUNumber(
    ULong.SIZE_BYTES,
    0u,
    ULong::toULong,
    ULong::or,
