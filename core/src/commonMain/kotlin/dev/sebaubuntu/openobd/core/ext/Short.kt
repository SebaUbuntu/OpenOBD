...
inline operator fun <reified N : Number> Short.minus(other: N): Number = when (other) {
    is Byte -> minus(other)
...
inline operator fun <reified N : Number> Short.times(other: N): Number = when (other) {
    is Byte -> times(other)
...
inline operator fun <reified N : Number> Short.div(other: N): Number = when (other) {
    is Byte -> div(other)
    is Double -> div(other)
    is Float -> div(other)
    is Int -> div(other)
...
inline operator fun <reified N : Number> Short.rem(other: N): Number = when (other) {
    is Byte -> rem(other)
    is Double -> rem(other)
    is Float -> rem(other)
    is Int -> rem(other)
