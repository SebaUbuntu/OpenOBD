...
inline operator fun <reified N : Number> Byte.compareTo(other: N): Int = when (other) {
...
inline operator fun <reified N : Number> Byte.plus(other: N): Number = when (other) {
    is Byte -> plus(other)
...
inline operator fun <reified N : Number> Byte.minus(other: N): Number = when (other) {
    is Byte -> minus(other)
...
inline operator fun <reified N : Number> Byte.times(other: N): Number = when (other) {
    is Byte -> times(other)
...
inline operator fun <reified N : Number> Byte.div(other: N): Number = when (other) {
    is Byte -> div(other)
    is Double -> div(other)
    is Float -> div(other)
    is Int -> div(other)
